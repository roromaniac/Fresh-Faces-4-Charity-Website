...
def help_page() -> rx.Component:
    return page_shell(
        page_heading("FAQ", "Questions from the lanes, answers from the night"),
        rx.el.p(
            ...
            ".",
            class_name="mb-6 text-center text-sky-100/80",
        ),
        rx.el.div(
            _faq_item(
                ...
                rx.el.p(
                    ...
                    class_name="ff-scala-font text-sky-50/90",
                ),
            ),
            _faq_item(
            ...
            _faq_item(
                ...
                rx.el.p(
                    "It depends on how well you did. To keep Fresh Faces populated by true novices and newcomers, we have a ",
                    rx.el.a(
                        "lookup tool",
                        href="/tools#ff4-eligibility-lookup",
                        class_name="text-amber-200 underline decoration-amber-200/40 hover:text-amber-100",
                    ),
                    " that lets you search if you are eligible for Fresh Faces 4. If you believe there has been a mistake, please contact roromaniac directly on Discord.",
                    class_name="ff-scala-font text-sky-50/90",
                ),
            ),
            _faq_item(
                ...
                rx.el.p(
                    ...
                    rx.el.a(
                        "RSVP link",
                        href="https://docs.google.com/forms/d/e/1FAIpQLScC0O1uNJnGnCoe7lMz4bCrZdrDUvXsboHZmjsMCSPWj-GY5g/viewform",
                        class_name="text-amber-200 underline decoration-amber-200/40 hover:text-amber-100",
                    ),
                    "! You can also click the button in the navbar.",
                    class_name="ff-scala-font text-sky-50/90",
                ),
            ),
            _faq_item(
