...
def about() -> rx.Component:
    return page_shell(
        page_heading(
            "About Fresh Faces 4",
            "A letter from the night's director",
        ),
        rx.el.article(
            rx.el.p(
                ...
                class_name="ff-scala-font mb-6 text-lg leading-relaxed text-sky-50/90",
            ),
            rx.el.p(
            ...
            rx.el.p(
                ...
                class_name="ff-scala-font mb-8 text-lg leading-relaxed text-sky-50/90",
            ),
            rx.el.div(
                rx.el.p("Slava Ukraini,", class_name="ff-script-font text-amber-200"),
                rx.el.p("roro", class_name="ff-menu-bold-font mt-1 text-sky-100"),
